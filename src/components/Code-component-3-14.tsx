      ...
      <div className="container mx-auto px-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between pt-2">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-muted-foreground text-xs">{segment.participants}</span>
                      </div>
        ...
        >
          <div className="bg-muted border border-border rounded-lg p-8 max-w-3xl mx-auto">
            <h3 className="text-xl font-semibold text-foreground mb-4">Ready to Compete?</h3>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <motion.button
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="border border-border text-foreground hover:bg-muted px-6 py-3 rounded-lg font-medium transition-all duration-300"
              >
                Download Rules
              </motion.button>
            </div>
